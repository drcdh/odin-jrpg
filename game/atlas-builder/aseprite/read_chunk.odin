...
read_old_palette_256 :: proc(
	r: io.Reader,
	rt: ^int,
	allocator := context.allocator,
) -> (
	chunk: Old_Palette_256_Chunk,
	err: Unmarshal_Error,
) {
...
read_old_palette_64 :: proc(
	r: io.Reader,
	rt: ^int,
	allocator := context.allocator,
) -> (
	chunk: Old_Palette_64_Chunk,
	err: Unmarshal_Error,
) {
	op_size := cast(int)read_word(r, rt) or_return
...
read_color_profile :: proc(
	r: io.Reader,
	rt: ^int,
	warned: ^bool,
	allocator := context.allocator,
) -> (
	chunk: Color_Profile_Chunk,
	err: Unmarshal_Error,
) {
...
read_external_files :: proc(
	r: io.Reader,
	rt: ^int,
	allocator := context.allocator,
) -> (
	chunk: External_Files_Chunk,
	err: Unmarshal_Error,
) {
