...
read_ud_value :: proc(
	...
	case .Null:
		return nil, nil
	case .Bool:
		return read_bool(r, n)
	case .I8:
		return read_i8(r, n)
	case .U8:
		return read_byte(r, n)
	case .I16:
		return read_short(r, n)
	case .U16:
		return read_word(r, n)
	case .I32:
		return read_long(r, n)
	case .U32:
		return read_dword(r, n)
	case .I64:
		return read_long64(r, n)
	case .U64:
		return read_qword(r, n)
	case .Fixed:
		return read_fixed(r, n)
	case .F32:
		return read_float(r, n)
	case .F64:
		return read_double(r, n)
	case .String:
		return read_string(r, n)
	case .Point:
		return read_point(r, n)
	case .Size:
		return read_size(r, n)
	case .Rect:
		return read_rect(r, n)
	case .UUID:
		return read_uuid(r, n)
